...
/***/ function(module, exports, __webpack_require__) {
	...
	var Recognize = function () {
	    ...
	    (0, _createClass3.default)(Recognize, [{
	        ...
	        key: "filterText",
	        value: function filterText(data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PDollarRecognizer = function () {
	    function PDollarRecognizer() {
	        ...
	        this.PointClouds[0] = new _PointCloud2.default({ name: "30", points: new Array(new _Point2.default(100, 0, 1), new _Point2.default(0, 100, 1), new _Point2.default(100, 0, 2), new _Point2.default(200, 100, 2), new _Point2.default(100, 0, 3), new _Point2.default(0, 300, 3)) });
	        this.PointClouds[1] = new _PointCloud2.default({ name: "40", points: new Array(new _Point2.default(100, 0, 1), new _Point2.default(0, 300, 1), new _Point2.default(0, 200, 2), new _Point2.default(100, 300, 2), new _Point2.default(200, 200, 2)) });
	        ...
	        this.PointClouds[4] = new _PointCloud2.default({ name: "50", points: new Array(new _Point2.default(0, 0, 1), new _Point2.default(0, 100, 1), new _Point2.default(200, 100, 1), new _Point2.default(200, 100, 2), new _Point2.default(200, 0, 2)) });
	        this.PointClouds[5] = new _PointCloud2.default({ name: "60", points: new Array(new _Point2.default(0, 0, 1), new _Point2.default(0, 100, 1), new _Point2.default(0, 0, 2), new _Point2.default(200, 0, 2), new _Point2.default(200, 100, 2)) });
	        ...
	        this.subPoints[3] = new _PointCloud2.default({ name: "04", points: new Array(new _Point2.default(0, 0, 1), new _Point2.default(100, 0, 1)) });
	        this.subPoints[4] = new _PointCloud2.default({ name: "05", points: new Array(new _Point2.default(0, 100, 1), new _Point2.default(100, 100, 1), new _Point2.default(100, 0, 1)) });
	        this.subPoints[5] = new _PointCloud2.default({ name: "06", points: new Array(new _Point2.default(0, 0, 1), new _Point2.default(0, 100, 1), new _Point2.default(100, 100, 1)) });
	        this.subPoints[6] = new _PointCloud2.default({ name: "07", points: new Array(new _Point2.default(0, 100, 1), new _Point2.default(0, 0, 1), new _Point2.default(100, 0, 1)) });
	        this.subPoints[7] = new _PointCloud2.default({ name: "08", points: new Array(new _Point2.default(0, 0, 1), new _Point2.default(100, 0, 1), new _Point2.default(100, 100)) });
	        this.subPoints[8] = new _PointCloud2.default({ name: "09", points: new Array(new _Point2.default(0, 100, 1), new _Point2.default(100 - pai, 100 + pai, 1), new _Point2.default(100, 200, 1), new _Point2.default(100 + pai, 100 + pai, 1), new _Point2.default(200, 100, 1), new _Point2.default(100 + pai, 100 - pai, 1), new _Point2.default(100, 0, 1), new _Point2.default(100 - pai, 100 - pai, 1)) });
	    }
	    ...
	    (0, _createClass3.default)(PDollarRecognizer, [{
	        ...
	        value: function splitByEdge(points) {
	            ...
	            var result = edges.filter(function (edge) {
